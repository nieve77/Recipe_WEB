...
<body>
	...
	<div class="container">
	<form action="recipe_CustomWriteUP.scv" method="post" enctype="multipart/form-data">
		<div class="row">
			<div class="col-md-12">
			...
			<div class="col-md-12">
				<div class="input-group">
					<span class="input-group-addon" id="sizing-addon2">공지 제목</span> <input
						...
						name="custom_title" aria-describedby="sizing-addon2">
				</div>
			</div>
		</div>
		<div class="row">
		...
		<div id="recipeWriteBody" class="row">
			<div class="col-md-12" id="writing">
				<section id="editor">
						<textarea id='edit' name="custom_content"></textarea>
				</section>
			</div>
		</div>
