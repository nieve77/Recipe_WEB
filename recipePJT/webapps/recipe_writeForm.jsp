...
<body>
	<h1>Cook Community 레시피 작성</h1>

	<div class="container">
	<form action="recipe_upload.scv" method="post" enctype="multipart/form-data">
		<div class="row">
			<div class="col-md-12">
				<div class="input-group">
					...
					<!-- /btn-group -->
					<input id="recipeTitleKate" type="text" name="recipe_category" class="form-control" >
				</div>
				<!-- /input-group -->
			</div>
			<!-- /.col-lg-6 -->
			...
			<div class="col-md-12">
				<div class="input-group">
					<span class="input-group-addon" id="sizing-addon2">요리 재료</span> <input
						...
						name="recipe_material" aria-describedby="sizing-addon2">
				</div>
			</div>
		</div>
			...
			<div class="col-md-12">
				<div class="input-group">
					<span class="input-group-addon" id="sizing-addon2">요리 제목</span> <input
						...
						name="recipe_name" aria-describedby="sizing-addon2">
				</div>
			</div>
		</div>
			...
			<div class="col-md-12">
				<div class="input-group">
					<span class="input-group-addon" id="sizing-addon2">간단한 설명</span> <input
						...
						name="recipe_feature" aria-describedby="sizing-addon2">
				</div>
			</div>
		</div>
		...
		<div class="row">
			<div id="recipeWriteBtn" class="col-md-6">
				<button type="button" class="btn btn-default">레시피 작성</button>
			</div>
		</div>
		...
		<div id="recipeWriteBody" class="row">
			<div class="col-md-12" id="writing">
				<section id="editor">
						<textarea id='edit' name="recipe_detail"></textarea>
				</section>
			</div>
		</div>
	...
	<script type="text/javascript">
		...
		$(document).ready(function() {
			...
			$("#recipeWriteBody").hide();
			var status = false;
			$("#recipeWriteBtn").on("click",function(){
				if(status == false){
				    /* alert("test"); */
					$("#recipeWriteBody").show();
					status = true;
				}else{
					$("#recipeWriteBody").hide();
					status = false;
